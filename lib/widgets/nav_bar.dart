      ...
      children: [
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: rankers[1]?['triangle'] ?? false
                    ? Image.asset('assets/green_triangle.png',
                        cacheHeight: 8, cacheWidth: 10)
                    : Image.asset('assets/red_triangle.png',
                        cacheHeight: 8, cacheWidth: 10),
              ),
              Image.asset(rankers[1]['profile_url'] ?? 'settings.png'),
              Text(
                rankers[1]['points'] ?? 'N/A',
        ...
        Expanded(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Image.asset(rankers[0]['profile_url'] ?? 'settings.png'),
              Text(
                rankers[0]['points'] ?? '0',
                style: Theme.of(context).textTheme.headlineSmall!.copyWith(
                      color: const Color(0xFF99B6FF),
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(6.0),
                child: rankers[2]['triangle'] ?? false
                    ? Image.asset('assets/green_triangle.png',
                        cacheHeight: 8, cacheWidth: 10)
                    : Image.asset('assets/red_triangle.png',
                        cacheHeight: 8, cacheWidth: 10),
              ),
              Image.asset(rankers[2]['profile_url'] ?? 'settings.png'),
              Text(
                rankers[2]['points'] ?? '0',
                style: Theme.of(context).textTheme.headlineSmall!.copyWith(
                      color: const Color(0xFF99B6FF),
